...
def ncbi_search(country, limit):
    ...
    params = {'db': 'nuccore', 'term': f"HIV-1[Organism] AND Pol[Gene Name] AND {country}[Title Word]", 'retmode': 'json', 'rettype': 'json', 'retmax': limit}
    ...
    try:
        ...
        data_downloader.query_ncbi(id_lists)
